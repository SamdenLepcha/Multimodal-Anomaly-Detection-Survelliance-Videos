...
def get_swin_model(args):
    ...
    if int(args.img_res) == 384:
        ...
        config_path = os.path.join(BASE_DIR, f"src/modeling/video_swin/swin_{args.vidswin_size}_384_patch244_window81212_kinetics{args.kinetics}_22k.py")
        model_path = os.path.join(BASE_DIR, f"models/video_swin_transformer/swin_{args.vidswin_size}_384_patch244_window81212_kinetics{args.kinetics}_22k.pth")
    else:
        config_path = os.path.join(BASE_DIR, f"src/modeling/video_swin/swin_{args.vidswin_size}_patch244_window877_kinetics{args.kinetics}_22k.py")
        model_path = os.path.join(BASE_DIR, f"models/video_swin_transformer/swin_{args.vidswin_size}_patch244_window877_kinetics{args.kinetics}_22k.pth")
        
    if args.pretrained_2d:
        config_path = os.path.join(BASE_DIR, "src/modeling/video_swin/swin_base_patch244_window877_kinetics400_22k.py")
        model_path = os.path.join(BASE_DIR, "models/swin_transformer/swin_base_patch4_window7_224_22k.pth")
